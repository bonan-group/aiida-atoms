The aiida-atoms plugin for `AiiDA`_
=====================================================
...
Please contact zhubonan@outlook.com for information concerning ``aiida-atoms`` and the `AiiDA mailing list <http://www.aiida.net/mailing-list/>`_ for questions concerning ``aiida``.
